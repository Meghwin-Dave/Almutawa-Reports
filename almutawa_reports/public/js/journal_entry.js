...
$.extend(erpnext.journal_entry, {
    ...
    quick_entry: function (frm) {
            ...
            fields: [
                ...
                },
                {
                    ...
                    get_query: function () {
                        return {
                            filters: {
                                company: frm.doc.company, // Filter departments by company
                            },
                        };
                    },
                    onchange: function () {
                        // Clear the project field when department changes
                        dialog.fields_dict.project.set_value("");
                    },
                },
                {
                    fieldtype: "Link",
                    ...
                    get_query: function () {
                        ...
                        return {
                            filters: {
                                department: selected_department, // Filter projects by selected department
                            },
                        };
                    },
                },
        ...
        dialog.set_primary_action(__("Save"), function () {
            ...
            frappe.model.set_value(debit_row.doctype, debit_row.name, "project", values.project);
            frappe.model.set_value(debit_row.doctype, debit_row.name, "department", values.department);
            ...
            frappe.model.set_value(credit_row.doctype, credit_row.name, "project", values.project);
            frappe.model.set_value(credit_row.doctype, credit_row.name, "department", values.department);
