...
frappe.treeview_settings["Account"] = {
    onload: function (treeview) {
        // Automatically expand all nodes after the tree is rendered
        frappe.after_ajax(() => {
            setTimeout(() => {
                if (treeview && typeof treeview.expand_all === "function") {
                    treeview.expand_all();
                }
            }, 500); // Delay to ensure tree is fully rendered
        });
    },
};
...
frappe.views.TreeView = class TreeView {
	...
	make_tree() {
        ...
        this.tree = new frappe.ui.Tree({
            ...
            expandable: true, // Ensure nodes are expandable
            expand_all: true, // Automatically expand all nodes
            args: this.args,
        ...
        // Automatically expand the tree on load
